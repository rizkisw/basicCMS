...
<head>
    ...
    <meta name="author" content="Rizki Sukma Wijaya" />
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="<?php echo site_url('backend/dashboard'); ?>" class="logo-text"><span>BLOG</span></a>
                </div><!-- Logo Box -->
        ...
        <div class="page-inner">
            ...
            <div class="page-footer">
                <p class="no-s"><?php echo date('Y'); ?> &copy; Powered by Rizki Sukma Wijaya</p>
            </div>
        </div><!-- Page Inner -->
    </main><!-- Page Content -->
